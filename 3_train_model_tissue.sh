...
# Trains tissue-conditioned RiboTransPred (FiLM) with DDP across 3 nodes / 24 GPUs
...
# ============ TRAINING ============
echo "Starting tissue FiLM training with srun..."
echo "========================================="
...
if [ $TRAIN_EXIT -eq 0 ]; then
    echo "========================================="
    echo "Tissue FiLM training completed successfully!"
    echo "========================================="

    # ============ TESTING ============
    # Find the best checkpoint from training
    SAVE_DIR=$(ls -td results_tissues/tissue_film_* 2>/dev/null | head -n 1)
